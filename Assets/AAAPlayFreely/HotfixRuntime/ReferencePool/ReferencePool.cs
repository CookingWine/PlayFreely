...
namespace PlayFreely.HotfixRuntime
{
    ...
    public static partial class ReferencePool
    {
        ...
        /// 引用池集合
        /// </summary>
        private static readonly IDictionary<string , ReferenceCollection> m_ReferenceCollections = new Dictionary<string , ReferenceCollection>( );
        ...
        /// 获取所以引用池的信息
        /// </summary>
        /// <returns>所以引用池的信息</returns>
        public static ReferencePoolInfo[] GetAllReferencePoolInfos( )
        {
            int index = 0;
            ReferencePoolInfo[] results = null;
            results = new ReferencePoolInfo[m_ReferenceCollections.Count];
            foreach(KeyValuePair<string , ReferenceCollection> item in m_ReferenceCollections)
            {
        ...
        private static ReferenceCollection GetReferenceCollection(Type referenceType)
        {
            ...
            if(!m_ReferenceCollections.TryGetValue(fullName , out ReferenceCollection referenceCollection))
            {
                referenceCollection = new ReferenceCollection(referenceType);
                m_ReferenceCollections.Add(fullName , referenceCollection);
            }
