...
namespace PlayFreely.BuiltinRuntime
{
    ...
    public class UIGradient:BaseMeshEffect
    {
        ...
        [SerializeField]
        private Type m_GradientType;

        [SerializeField]
        private Blend m_BlendMode = Blend.Multiply;

        /// <summary>
        /// 添加顶点以显示复杂的渐变。如果形状已经非常复杂，比如文本，请关闭
        /// </summary>
        [SerializeField]
        private bool m_ModifyVertices = false;
        ...
        [SerializeField]
        private Gradient m_EffectGradient = new Gradient( )
        {
        ...
        public bool ModifyVertices
        {
            get
            {
                return m_ModifyVertices;
            }
            set
            {
                m_ModifyVertices = value;
                graphic.SetVerticesDirty( );
            }
        }
